...
gadgets = {
	...
	-- 发奖相关
	[1048] = { config_id = 1048, gadget_id = 70210106, pos = { x = 0.063, y = 0.147, z = 8.240 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "女士", persistent = true, boss_chest = { monster_config_id = 1004, resin=1, life_time = 1800, take_num = 100} }
}
