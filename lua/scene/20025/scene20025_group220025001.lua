...
gadgets = {
	...
	{ config_id = 1011, gadget_id = 70210106, pos = { x = 10.943, y = -0.114, z = 73.826 }, rot = { x = 0.000, y = 8.619, z = 0.000 }, level = 26, drop_tag = "风魔龙", showcutscene = true, persistent = true, boss_chest = { monster_config_id = 1001, resin=1, life_time = 1800, take_num = 100} },
