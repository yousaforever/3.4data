...
gadgets = {
	...
	{ config_id = 95021, gadget_id = 70210106, pos = { x = 261.149, y = 225.444, z = 218.573 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 16, drop_tag = "深海龙蜥组合", persistent = true, boss_chest = {monster_config_id=95003, resin=1, life_time=600, take_num=100}, area_id = 200 },
	{ config_id = 95022, gadget_id = 70210106, pos = { x = 247.214, y = 225.394, z = 207.733 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 16, drop_tag = "深海龙蜥组合", persistent = true, boss_chest = {monster_config_id=95005, resin=1, life_time=600, take_num=100}, area_id = 200 }
}
