...
-- 装置
gadgets = {
	{ config_id = 43002, gadget_id = 70210106, pos = { x = 48.530, y = 248.872, z = 2122.358 }, rot = { x = 0.000, y = 222.905, z = 0.000 }, level = 26, drop_tag = "掣电树", showcutscene = true, persistent = true, boss_chest = {monster_config_id=43001, resin=1, life_time=600, take_num=100}, area_id = 20 }
}
