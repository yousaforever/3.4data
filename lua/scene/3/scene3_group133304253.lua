...
-- 装置
gadgets = {
	{ config_id = 253002, gadget_id = 70210106, pos = { x = -1332.626, y = 174.334, z = 2105.636 }, rot = { x = 0.000, y = 342.291, z = 0.000 }, level = 26, drop_tag = "兆载永劫龙兽", showcutscene = true, persistent = true, boss_chest = {monster_config_id=253001, resin=1, life_time=600, take_num=100}, area_id = 21 }
}
