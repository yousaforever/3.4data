...
-- 装置
gadgets = {
	{ config_id = 3279, gadget_id = 70210106, pos = { x = 1309.352, y = 330.010, z = -1942.557 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 11, drop_tag = "无相之雷", showcutscene = true, persistent = true, boss_chest = {monster_config_id=1372, resin=1,life_time=600, take_num=100}, area_id = 2 },
