...
gadgets = {
	...
	{ config_id = 259005, gadget_id = 70210106, pos = { x = 1984.880, y = 250.190, z = -246.872 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 11, drop_tag = "北风狼", showcutscene = true, persistent = true, boss_chest = {monster_config_id=954, resin=1, life_time=600, take_num=100}, area_id = 3 },
