...
-- 装置
gadgets = {
	{ config_id = 20002, gadget_id = 70210106, pos = { x = 47.482, y = 200.738, z = -854.014 }, rot = { x = 0.000, y = 253.266, z = 0.000 }, level = 26, drop_tag = "无相之岩", showcutscene = true, persistent = true, boss_chest = {monster_config_id=20001, resin=1, life_time=600, take_num=100}, area_id = 7 },
