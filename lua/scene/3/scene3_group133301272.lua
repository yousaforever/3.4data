...
-- 装置
gadgets = {
	{ config_id = 272003, gadget_id = 70210106, pos = { x = -104.634, y = 78.323, z = 3881.186 }, rot = { x = 0.000, y = 263.406, z = 0.000 }, level = 26, drop_tag = "翠翎恐蕈", showcutscene = true, persistent = true, boss_chest = {monster_config_id=272001,resin=1, life_time=600, take_num=100}, area_id = 22 }
}
