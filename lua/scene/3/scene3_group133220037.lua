...
-- 装置
gadgets = {
	{ config_id = 37004, gadget_id = 70210106, pos = { x = -2130.543, y = 138.810, z = -4455.603 }, rot = { x = 0.000, y = 135.914, z = 0.000 }, level = 26, drop_tag = "恒常机关阵列", isOneoff = true, persistent = true, boss_chest = {monster_config_id=37005, resin=1, life_time=600, take_num=100}, area_id = 11 }
}
