...
-- 装置
gadgets = {
	{ config_id = 543003, gadget_id = 70210106, pos = { x = 2101.444, y = 190.592, z = -1680.776 }, rot = { x = 0.000, y = 338.343, z = 0.000 }, level = 1, drop_tag = "急冻树", showcutscene = true, persistent = true, boss_chest = {monster_config_id=543001, resin=1, life_time=600, take_num=100}, area_id = 1 }
}
