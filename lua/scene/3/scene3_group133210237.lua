...
-- 装置
gadgets = {
	{ config_id = 237005, gadget_id = 70210106, pos = { x = -3550.104, y = 116.858, z = -965.675 }, rot = { x = 0.000, y = 302.759, z = 0.000 }, level = 26, drop_tag = "无相之水", persistent = true, boss_chest = {monster_config_id=237001, resin=1, life_time=600, take_num=100}, area_id = 17 },
