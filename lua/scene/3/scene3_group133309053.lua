...
-- 装置
gadgets = {
	{ config_id = 53002, gadget_id = 70210106, pos = { x = -2787.094, y = 145.045, z = 5284.615 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 26, drop_tag = "半永恒统辖矩阵", showcutscene = true, persistent = true, boss_chest = {monster_config_id=53001, resin=1, life_time=600, take_num=100}, area_id = 27 }
}
