...
-- 装置
gadgets = {
	{ config_id = 657002, gadget_id = 70210106, pos = { x = 1173.012, y = 285.416, z = -547.383 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "无相之冰", isOneoff = true, persistent = true, boss_chest = {monster_config_id=657001, resin=1,life_time=600, take_num=100}, area_id = 10 },
