...
-- 装置
gadgets = {
	{ config_id = 51002, gadget_id = 70210106, pos = { x = -2438.892, y = 239.355, z = 3895.092 }, rot = { x = 0.000, y = 357.941, z = 0.000 }, level = 26, drop_tag = "无相之草", showcutscene = true, persistent = true, boss_chest = {monster_config_id=51001, resin=1, life_time=600, take_num=100}, area_id = 26 }
}
