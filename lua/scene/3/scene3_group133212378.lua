...
-- 装置
gadgets = {
	{ config_id = 378002, gadget_id = 70210106, pos = { x = -3937.224, y = 261.553, z = -2344.111 }, rot = { x = 0.000, y = 342.291, z = 0.000 }, level = 26, drop_tag = "魔偶剑鬼", showcutscene = true, persistent = true, boss_chest = {monster_config_id=378001, resin=1, life_time=600, take_num=100}, area_id = 13 }
}
