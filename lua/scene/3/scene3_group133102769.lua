...
gadgets = {
	...
	{ config_id = 769054, gadget_id = 70210106, pos = { x = 1787.825, y = 200.490, z = 271.990 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 16, drop_tag = "纯水精灵", isOneoff = true, persistent = true, boss_chest = {monster_config_id=769026,resin=1,life_time=600,take_num=100}, area_id = 5 },
