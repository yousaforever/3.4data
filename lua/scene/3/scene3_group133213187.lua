...
-- 装置
gadgets = {
	{ config_id = 187002, gadget_id = 70210106, pos = { x = -3036.362, y = 200.174, z = -3182.963 }, rot = { x = 0.000, y = 342.291, z = 0.000 }, level = 26, drop_tag = "无相之火", showcutscene = true, persistent = true, boss_chest = {monster_config_id=187001, resin=1, life_time=600, take_num=100}, area_id = 12 }
}
