...
-- 装置
gadgets = {
	[275007] = { config_id = 275007, gadget_id = 70210106, pos = { x = -6643.583, y = 193.512, z = -2648.322 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "黄金王兽", isOneoff = true, persistent = true, boss_chest = {monster_config_id=275002, resin=1, life_time=600,take_num=100}, area_id = 18 }
}
