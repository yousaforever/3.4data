...
gadgets = {
	...
	{ config_id = 640008, gadget_id = 70210106, pos = { x = 194.427, y = 185.011, z = 1502.574 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 21, drop_tag = "古岩龙蜥火", persistent = true, boss_chest = {monster_config_id=640001, resin=1, life_time=600,take_num=100}, area_id = 6 },
	{ config_id = 640009, gadget_id = 70210106, pos = { x = 194.427, y = 185.011, z = 1502.574 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 21, drop_tag = "古岩龙蜥水", persistent = true, boss_chest = {monster_config_id=640003, resin=1, life_time=600,take_num=100}, area_id = 6 },
	{ config_id = 640010, gadget_id = 70210106, pos = { x = 194.427, y = 185.011, z = 1502.574 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 21, drop_tag = "古岩龙蜥冰", persistent = true, boss_chest = {monster_config_id=640005, resin=1, life_time=600,take_num=100}, area_id = 6 },
	{ config_id = 640011, gadget_id = 70210106, pos = { x = 194.427, y = 185.011, z = 1502.574 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 21, drop_tag = "古岩龙蜥电", persistent = true, boss_chest = {monster_config_id=640006, resin=1, life_time=600,take_num=100}, area_id = 6 }
}
