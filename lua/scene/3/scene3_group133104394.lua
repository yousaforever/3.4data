...
-- 装置
gadgets = {
	{ config_id = 394002, gadget_id = 70210106, pos = { x = 159.646, y = 197.142, z = 952.696 }, rot = { x = 0.000, y = 295.500, z = 0.000 }, level = 16, drop_tag = "爆炎树", showcutscene = true, persistent = true, boss_chest = {monster_config_id=394004,resin=1, life_time=600, take_num=100}, area_id = 6 }
}
