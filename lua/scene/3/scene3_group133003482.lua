...
-- 装置
gadgets = {
	{ config_id = 4352, gadget_id = 70210106, pos = { x = 2908.285, y = 269.918, z = -1301.327 }, rot = { x = 0.000, y = 342.291, z = 0.000 }, level = 26, drop_tag = "无相之风", showcutscene = true, persistent = true, boss_chest = {monster_config_id=1722, resin=1, life_time=600, take_num=100}, area_id = 1 },
