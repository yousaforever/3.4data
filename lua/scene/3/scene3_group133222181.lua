...
-- 装置
gadgets = {
	{ config_id = 181002, gadget_id = 70210106, pos = { x = -4707.962, y = 480.009, z = -4258.291 }, rot = { x = 0.000, y = 338.343, z = 0.000 }, level = 26, drop_tag = "雷音权现", showcutscene = true, persistent = true, boss_chest = {monster_config_id=181001, resin=1, life_time=600, take_num=100}, area_id = 14 },
