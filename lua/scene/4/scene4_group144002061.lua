...
-- 装置
gadgets = {
	{ config_id = 61002, gadget_id = 70210106, pos = { x = 134.317, y = 121.217, z = -166.241 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 16, drop_tag = "魔偶剑鬼", isOneoff = true, persistent = true, boss_chest = {monster_config_id=61001, resin=1, life_time=600, take_num=100}, area_id = 101 }
}
