...
-- 装置
gadgets = {
	{ config_id = 287002, gadget_id = 70210106, pos = { x = 736.155, y = 925.155, z = 1001.237 }, rot = { x = 0.000, y = 342.291, z = 0.000 }, level = 26, drop_tag = "遗迹巨蛇", showcutscene = true, persistent = true, boss_chest = {monster_config_id=287001, resin=1, life_time=600, take_num=100}, area_id = 300 },
