...
gadgets = {
	...
	{ config_id = 1005, gadget_id = 70210106, pos = { x = 0.208, y = 0.000, z = 6.408 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "雷电将军", persistent = true, boss_chest = { monster_config_id=1001, resin=1, life_time = 1800, take_num = 100} }
}
