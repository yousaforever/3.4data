...
gadgets = {
	...
	{ config_id = 1012, gadget_id = 70210106, pos = { x = 526.934, y = 74.192, z = 465.003 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "若陀龙王火电", persistent = true, boss_chest = { monster_config_id=1001, resin=1, life_time = 1800, take_num = 100} },
