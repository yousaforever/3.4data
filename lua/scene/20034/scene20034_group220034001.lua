...
gadgets = {
	...
	{ config_id = 1032, gadget_id = 70210106, pos = { x = -0.088, y = -56.267, z = 10.465 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 11, drop_tag = "公子", persistent = true, boss_chest = {monster_config_id=1009, resin=1, life_time=1800, take_num=100} }
}
